...
public class FrogBlue implements IFrogBlue {
    private Game2 game;
    ...
    public void move(Direction key){
        ...
        if (key == Direction.Z && this.cases.ord + 1 < this.game.height && !this.game.getEnvironment().getLane(this.cases.ord + 1).isInCase(new Case(this.cases.absc, this.cases.ord + 1)) && estEnVie) {
        ...
        if (key == Direction.S && this.cases.ord - 1 >= 0 && !this.game.getEnvironment().getLane(this.cases.ord - 1).isInCase(new Case(this.cases.absc, this.cases.ord - 1)) && estEnVie) {
        ...
        if (key == Direction.Q && this.cases.absc - 1 >= 0 && !this.game.getEnvironment().getLane(this.cases.ord).isInCase(new Case(this.cases.absc - 1, this.cases.ord)) && estEnVie) {
        ...
        if (key == Direction.D && this.cases.absc + 1 < this.game.width && !this.game.getEnvironment().getLane(this.cases.ord).isInCase(new Case(this.cases.absc + 1, this.cases.ord)) && estEnVie) {
